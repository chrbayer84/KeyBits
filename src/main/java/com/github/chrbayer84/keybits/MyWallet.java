...
public class MyWallet {
    ...
    private String wallet_file_name;
    ...
    public MyWallet(String wallet_file_name, String blockchain_file_name, String checkpoints_file_name, String passphrase){
        this.wallet_file_name = wallet_file_name;
        this.blockchain_file_name = blockchain_file_name;
     ...
     * @throws Exception Throws exception if something goes wrong.
     */
    public void openWallet(int n) throws Exception{
    ...
    public void openBlockStore() throws Exception{
        ...
        if (!blockchain_file.exists() && this.checkpoints_file_name != null && this.is_new_wallet) {
            // if blockstore does not exist, set key creation time to current time since we do not want to download the whole chain
            ...
            CheckpointManager.checkpoint(this.net_params, stream, this.block_store, this.wallet.getEarliestKeyCreationTime());
        } else  
            this.block_store = new SPVBlockStore(this.net_params, blockchain_file);
        
        this.blockchain = new BlockChain(this.net_params, this.wallet, this.block_store);   // initialize BlockChain object
    }
     ...
     * @throws Exception Throws exception if something goes wrong.
     */
    public void openPeerGroup() throws Exception{
     ...
     * @throws Exception Throws exception if something goes wrong.
     */
    public Transaction send(String address, BigInteger amount) throws Exception{        
     ...
     * @throws Exception Throws exception if something goes wrong.
     */
    public Transaction sendMultiple(String[] addresses, BigInteger[] amounts) throws Exception{
     ...
     * @throws Exception Throws exception if something goes wrong.
     */
    public void closeWallet() throws Exception{
        this.encrypt();
        this.wallet.saveToFile(this.wallet_file);   // save wallet contents to disk
    }
    
    public void closeBlockStore() throws Exception{
     ...
     */
    public static void createWallet(String wallet_file_name, String blockchain_file_name, int number_of_addresses, String passphrase) throws Exception{
     ...
     * @throws Exception Throws an exception if something goes wrong.
     */
    public static void updateWallet(String wallet_file_name, String blockchain_file_name, String checkpoints_file_name) throws Exception{
    ...
    public static void updateWallet(String wallet_file_name, String blockchain_file_name) throws Exception{
     ...
     * @throws Exception Throws an exception if something goes wrong.
     */
    public static BigInteger getBalanceOfWallet(String wallet_file_name, String blockchain_file_name) throws Exception{     
    ...
    public static boolean removeKey(String wallet_file_name, String blockchain_file_name, String address) throws Exception{     
        MyWallet wallet = new MyWallet(wallet_file_name, blockchain_file_name);
    ...
    public static void setCreationTime(String wallet_file_name, long epoch) throws Exception{       
     ...
     */
    public static String getAddress(String wallet_file_name, String blockchain_file_name, int index) throws Exception{
        MyWallet wallet = new MyWallet(wallet_file_name, blockchain_file_name);
                
        wallet.openWallet();
        
        String address = wallet.getWallet().getKeys().get(index).toAddress(wallet.getNetworkParameters()).toString();
     ...
     * @throws Exception Throws an exception if something goes wrong.
     */
    public static String showContentOfWallet(String wallet_file_name, String blockchain_file_name) throws Exception{
        MyWallet wallet = new MyWallet(wallet_file_name, blockchain_file_name);
     ...
     * @throws Exception Throws exception if something goes wrong.
     */
    public static Transaction sendCoins(String wallet_file_name, String blockchain_file_name, String checkpoints_file_name, String address, BigInteger amount, String passphrase) throws Exception{
    ...
    /**
     * Monitors a pending transaction. Idea is, that, after a transaction was done using, e.g. sendCoins,
     * following coding using the sending wallet should wait until transaction is not pending anymore.
     * This is achieved with this method.
     * 
     * @param wallet_file_name The wallet file.
     * @param blockchain_file_name The blockchain file.
     ...
     * @throws Exception Throws exception if something goes wrong.
     */
    public static void monitorPendingTransaction(String wallet_file_name, String blockchain_file_name, String checkpoints_file_name, final Transaction transaction) throws Exception{
     ...
     * @throws Exception Throws an exception if something goes wrong.
     */
    public static void monitorPendingTransactions(String wallet_file_name, String blockchain_file_name, String checkpoints_file_name) throws Exception{
        final MyWallet wallet = new MyWallet(wallet_file_name, blockchain_file_name, checkpoints_file_name, null);
    ...
    /**
     * Monitors depth in blockchain of a transaction. Idea is, that, after a transaction was recognized by the
     * receiving wallet, the following code should wait until transaction is deep enough in blockchain, usually
     * depth >= 6. This is achieved with this method.
     * 
     * @param wallet_file_name The wallet file.
     * @param blockchain_file_name The blockchain file.
     * @param transaction The transaction which is to be monitored.
     ...
     * @throws Exception Throws exception if something goes wrong.
     */
    public static void monitorTransactionDepth(String wallet_file_name, String blockchain_file_name, String checkpoints_file_name, final Transaction transaction, final int depth) throws Exception{
        final MyWallet wallet = new MyWallet(wallet_file_name, blockchain_file_name, checkpoints_file_name, null);
     ...
     * @throws Exception Throws exception if something goes wrong.
     */
    public static void monitorTransactionDepth(String wallet_file_name, String blockchain_file_name, String checkpoints_file_name, final int depth) throws Exception{
        final MyWallet wallet = new MyWallet(wallet_file_name, blockchain_file_name, checkpoints_file_name, null);
                    ...
                    while (iterator.hasNext()){
                        ...
                        if (transaction.equals(tx)){
                            if (transaction.getConfidence().getDepthInBlocks() < depth ||
                                ...
                                //System.out.println(transaction.getHashAsString() + "\t" + transaction.getConfidence().getDepthInBlocks());
                                exists_flat_transaction = true;
                            }
                        }
                    }
     ...
     * @throws Exception Throws exception if something goes wrong.
     */
    public static Transaction createKeys(String wallet_file_name, String blockchain_file_name, String checkpoints_file_name, String[] addresses, BigInteger fee, BigInteger amount_per_address, String passphrase) throws Exception{
        MyWallet wallet = new MyWallet(wallet_file_name, blockchain_file_name, checkpoints_file_name, passphrase);
        ...
        BigInteger needed = new BigInteger("" + (number_of_transactions*amount_per_address.longValue() + fee.longValue()));
    ...
    /**
     * Computes fees based on the number of input and output addresses as described at http://bitcoinfees.com.
     * Changed formula because of http://bitzuma.com/posts/making-sense-of-bitcoin-transaction-fees/
     * 
    ...
    public static int getFees(int number_of_inputs, int number_of_outputs){
        int bytes = 181*number_of_inputs + 35*number_of_outputs + 10;   // 35 instead of 34 because of to small fee for 112 addresses
