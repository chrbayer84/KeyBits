...
public class HelpfulStuff
{
    ...
    public static String insertPassphrase( String title )
        throws Exception
    {
        ...
        JOptionPane.showOptionDialog( null, panel, title, JOptionPane.NO_OPTION, JOptionPane.PLAIN_MESSAGE, null,
            options, options[1] );
        return pass.getText();
    }

    public static String reInsertPassphrase( String title )
        throws Exception
    {
        JPanel panel = new JPanel();
    ...
    public static int yesNo( String text )
        throws Exception
    {
    ...
    public static HashMap<String, String> readConfigFile( String config_file_name )
        throws Exception
    {
