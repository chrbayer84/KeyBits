...
/*
 * Copyright 2013 Google Inc. Copyright 2014 Andreas Schildbach Licensed under the Apache License, Version 2.0 (the
        ...
        throws Exception
    {
        ...
        chain.addListener( new AbstractBlockChainListener()
        {
                ...
                throws VerificationException
            {
                ...
                {
                    System.out.println( String.format( "Checkpointing block %s at height %d", block.getHeader()
                        .getHash(), block.getHeight() ) );
                    checkpoints.put( height, block );
                }
            }
        }, Threading.SAME_THREAD );

        peerGroup.addPeerDiscovery( new DnsDiscovery( new MainNetParams() ) );
        peerGroup.start();
